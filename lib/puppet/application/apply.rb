...
puppet apply [-h|--help] [-V|--version] [-d|--debug] [-v|--verbose]
  ...
  [-L|--loadclasses] [-W|--writeclasses] [--apply <catalog>] <file>
...
* --writeclasses:
  Writes out a classes.txt file, as would 'puppet agent'. Use
  --classfile to override the default path for the generated file
  (usually at /etc/puppet/classes.txt).
...
Copyright (c) 2011 Puppet Labs, LLC Licensed under the Apache 2.0 License
  ...
  def main
    ...
    begin
      ...
      catalog.write_class_file if options[:writeclasses]
